...
globalStyles.textContent = `
  .brand { display:inline-flex; align-items:center; line-height:0; min-width:0; overflow:visible; }
  .brand__logo { display:block; width:clamp(136px,12vw,188px); height:auto; max-width:100%; object-fit:contain; object-position:left center; }
  .site-footer .brand__logo { width:clamp(158px,15vw,220px); }
  .nav { min-height:74px; overflow:visible; }
  h1 { font-size:clamp(2.45rem,5.3vw,5.25rem) !important; line-height:1.02 !important; letter-spacing:0 !important; text-wrap:balance; }
  h2 { font-size:clamp(2rem,3.8vw,3.65rem) !important; line-height:1.05 !important; letter-spacing:0 !important; text-wrap:balance; }
  h3 { letter-spacing:0 !important; }
  .hero__content h1,.page-hero h1 { max-width:820px; }
  .section__head h2 { max-width:760px; }
  .problem-statement strong { font-size:clamp(2.05rem,4.2vw,4rem) !important; line-height:1.05 !important; }
  .reason-score strong { font-size:clamp(4.2rem,9vw,7.6rem) !important; }
  ...
  .nav__drop-trigger { min-height:42px; display:inline-flex; align-items:center; gap:7px; padding:0 13px; color:#e8dec9; font-size:.82rem; font-weight:700; text-transform:uppercase; letter-spacing:.08em; border:0; border-bottom:1px solid transparent; background:transparent; cursor:pointer; font-family:inherit; }
  ...
  .hero__content h1 { padding:.1em 0 .12em clamp(16px,3vw,34px); background:linear-gradient(90deg,rgba(240,207,130,.18),transparent 70%); border-left:3px solid rgba(240,207,130,.7); }
  ...
  .footer__column h3 { margin:0; color:var(--gold-bright); font-family:var(--font-body); font-size:.78rem; font-weight:800; letter-spacing:.13em !important; line-height:1.35; text-transform:uppercase; }
  ...
  .site-loader__panel img { width:min(210px,66vw); height:auto; }
